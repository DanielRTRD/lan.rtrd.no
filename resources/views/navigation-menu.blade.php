<nav x-data="{ open: false }" class="bg-black border-b border-gray-800 print:hidden">
                ...
                @role('super-admin|admin')
                    <div class="relative ml-3">
                        <x-jet-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-300 transition bg-gray-900 border border-transparent rounded-md hover:bg-gray-700 hover:text-gray-300 focus:outline-none focus:bg-gray-800 active:bg-gray-800">
            ...
            <div class="flex items-center px-4">
                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                    <div class="flex-shrink-0 mr-3">
                        <img class="object-cover w-10 h-10 rounded-full" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name ?? Auth::user()->username }}" />
                    </div>
                @endif

                <div>
                    <div class="text-base font-medium text-gray-800">{{ Auth::user()->name ?? Auth::user()->username }}</div>
