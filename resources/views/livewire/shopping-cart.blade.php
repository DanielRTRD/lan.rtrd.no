    ...
    @if ($this->order)
        ...
        <div class="relative h-full p-10 overflow-hidden wrap">
            ...
            <div class="flex items-center justify-between w-full mb-8">
                <div class="order-2 w-1/12"></div>
                <div class="z-20">
                    <div class="flex items-center w-10 h-10 {{ $this->order->paid ? 'bg-green-900' : 'bg-gray-900' }} rounded-full">
                        <h1 class="mx-auto font-semibold text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="order-1 w-10/12 px-6 py-4 ml-4 {{ $this->order->paid ? 'bg-green-900' : 'bg-gray-900' }} rounded-lg shadow-xl">
                    <div class="flex flex-row">
            ...
            <div class="flex items-center justify-between w-full mb-8">
                <div class="order-2 w-1/12"></div>
                <div class="z-20">
                    <div class="flex items-center w-10 h-10 {{ $this->order->ordered ? 'bg-green-900' : 'bg-gray-900' }} rounded-full">
                        <h1 class="mx-auto font-semibold text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="order-1 w-10/12 px-6 py-4 ml-4 {{ $this->order->ordered ? 'bg-green-900' : 'bg-gray-900' }} rounded-lg shadow-xl">
                    <div class="flex flex-row">
