    ...
    <div class="pt-4 bg-gray-900">
        <div class="flex flex-col items-center min-h-screen pt-6 sm:pt-0">
            ...
            <div class="items-center justify-center w-full p-6 mt-6 overflow-hidden text-center bg-gray-800 shadow-md sm:max-w-2xl sm:rounded-lg">
                ...
                <a href="{{ route('facebook.login') }}" class="block w-full h-12 px-6 py-3 mt-4 text-blue-100 transition-colors duration-150 bg-blue-700 rounded-lg shadow-lg focus:shadow-outline hover:bg-blue-800">
                    <svg width="20" height="20" fill="currentColor" class="inline-block w-5 h-5 mr-1" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1343 12v264h-157q-86 0-116 36t-30 108v189h293l-39 296h-254v759h-306v-759h-255v-296h255v-218q0-186 104-288.5t277-102.5q147 0 228 12z">
                        </path>
                    </svg> Login with Facebook
                </a>
                <p class="mt-4 text-gray-300">Noen opplever problemer med Facebook-innlogging, hvis du opplever det;<br>Bruk Discord-innloggingen!</p>
            </div>
        </div>
    </div>
</x-guest-layout>
