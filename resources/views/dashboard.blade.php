        ...
        <div class="flex flex-wrap -mx-1 lg:-mx-4">
            <div class="w-full px-1 my-1 md:w-full lg:my-4 lg:px-4 lg:w-1/2">
                <div class="p-8 py-4 overflow-hidden text-gray-200 bg-gray-800 rounded shadow-lg md:shadow-xl sm:rounded-lg">
                    <h1 class="py-2 text-2xl">Når? <span class="text-blue-400">{{ \Carbon\Carbon::parse(env('LAN_START_DATE'))->toFormattedDateString() }} &mdash; {{ \Carbon\Carbon::parse(env('LAN_END_DATE'))->toFormattedDateString() }}</span></h1>
                    <h1 class="py-2 text-2xl">Hvor? <span class="text-blue-400">Hjemme hos Daniel og Hanne<sup>&dagger;</sup></span></h1>
                    ...
                    <ul class="ml-2 list-disc list-inside">
                        <li>Kjellerstue: <span class="text-blue-400">Dobbelseng, sammenleggbar gjesteseng og luftmadrass</span></li>
                        <li>Gjesterom: <span class="text-blue-400">Dobbelseng</span></li>
                        <li>Kjellerrom: <span class="text-blue-400">Sammenleggbar gjesteseng</span></li>
                        <li>Kontor: <span class="text-blue-400">Plass til luftmadrass/sammenleggbar gjesteseng<sup>&dagger;&dagger;</sup></span></li>
                        <li>Åpen loftstue: <span class="text-blue-400">Plass til flere luftmadrasser/sammenleggbar gjestesenger<sup>&dagger;&dagger;</sup></span></li>
                    </ul>
                    <div class="mt-6">
